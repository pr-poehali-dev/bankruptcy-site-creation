...
export default function Index() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("Formspree.io/slafka1996@gmail.com", {
        method: "POST",
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                href="tel:+79047298933"
                className="text-lg text-yellow-400 hover:text-yellow-300 transition-colors flex items-center gap-2"
              >
                <Icon name="Phone" size={20} />
                +7 904 729-89-33
              </a>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: "Calendar",
                title: "Просрочка 3+ месяца",
                desc: "Невозможность платить по кредитам более 3 месяцев",
              },
              {
                icon: "AlertTriangle",
                title: "Давление коллекторов",
                desc: "Постоянные звонки, угрозы, испорченная кредитная история",
              },
            ].map((item, i) => (
              <Card
                key={i}
                className="border-2 border-yellow-400 hover:shadow-2xl hover:shadow-yellow-400/20 transition-all duration-300 animate-scale-in hover:scale-105"
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {[
              ...
              <AccordionItem
                key={i}
                value={`item-${i}`}
                className="bg-white border-2 border-yellow-400 rounded-lg px-6 hover:border-yellow-500 transition-colors"
              >
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={i}
                className="border-2 border-yellow-400 hover:border-yellow-500 transition-all duration-300 animate-fade-in hover:shadow-xl hover:shadow-yellow-400/20"
      ...
      >
        ...
        <div className="container mx-auto max-w-2xl">
          ...
          <div className="mt-12 text-center relative z-10">
            ...
            <a
              href="tel:+79047298933"
              className="text-3xl font-bold text-yellow-400 hover:text-yellow-300 transition-colors inline-flex items-center gap-3"
            >
